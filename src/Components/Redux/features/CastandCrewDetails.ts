...
// https://api.themoviedb.org/3/movie/27205/credits?api_key=0c2efce2a23fcafc5658862d35fc6291

export const FetchingcrewCast = createAsyncThunk("movie/27205/credits",async(movieId:number)=>{
...
const castcrewReducer =createSlice({
    ...
    extraReducers:(builder)=>{
        builder.addCase(FetchingcrewCast.pending,(state)=>{
